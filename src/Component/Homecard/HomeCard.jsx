...
{/* <Link to={`/carddetail/${_id}`} className="block w-full px-5 py-3 text-center text-white bg-gradient-to-r from-green-400 to-blue-500 rounded-lg shadow-md hover:from-green-500 hover:to-blue-600 transition-colors duration-300">
View Property
</Link>
</div> */}